...
- Medium and large boards can reveal violations in batches after earlier corners are repaired, so the production default is `60` adjustment rounds and the settings UI allows `1` to `100`.
